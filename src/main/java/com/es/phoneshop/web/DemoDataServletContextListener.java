...
public class DemoDataServletContextListener implements ServletContextListener {
    ...
    public void getSampleProducts() {
        ...
        productDao.save(new Product("sgs2", "Samsung Galaxy S II", new BigDecimal(200), usd, 1, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S%20II.jpg"));
